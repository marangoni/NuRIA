...
Data: 14.12.2018
Versão:2.2 - display_array
Funcionamento: Melhora o uso do display utilizando strings e arrays
...
void setup() {
   ...
   tela_1_linha0.toCharArray(linha0,17);
   tela_1_linha1.toCharArray(linha1,17);
}
